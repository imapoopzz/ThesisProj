export interface AITicket {
  ...
  status: 'auto-resolved' | 'auto-assigned' | 'needs-assignment' | 'in-progress' | 'resolved';
  ...
  aiResponse?: string; // For auto-resolved tickets
  aiDraft?: string; // For auto-assigned and needs-assignment tickets
  suggestedResponse?: string; // For auto-assigned and needs-assignment tickets
  progressDetails?: {
    status: string;
    assignedBy: string;
    lastUpdate: string;
...
export interface ProponentTask {
  id: string;
  ticketId: string;
  memberPseudonym: string;
...
export const mockAITickets: AITicket[] = [
  {
    id: '1',
    ...
    redactedDescription: 'Patient [REDACTED: NAME] requests financial aid for hospitalization. Emergency surgery required for [REDACTED: MEDICAL_CONDITION]. Total cost estimated at ₱85,000. Member has been with company for 3 years and is in good standing.',
    description: 'Patient Maria Santos requests financial aid for hospitalization. Emergency surgery required for appendicitis. Total cost estimated at ₱85,000. Member has been with company for 3 years and is in good standing.',
  ...
  },
  {
    ...
    redactedDescription: 'Member [REDACTED: NAME] reports wrongful termination by employer [REDACTED: COMPANY]. Seeking legal representation for case against [REDACTED: COMPANY] located at [REDACTED: ADDRESS]. Termination occurred on September 15, 2025 without proper notice.',
    description: 'Member Pedro Reyes reports wrongful termination by employer ABC Manufacturing. Seeking legal representation for case against ABC Manufacturing located at 123 Industrial St, Quezon City. Termination occurred on September 15, 2025 without proper notice.',
  ...
  },
  {
    ...
    priority: 'Normal',
    status: 'in-progress',
    redactedDescription: 'Member [REDACTED: NAME] applying for educational scholarship for child. Child will be enrolled in Computer Science program at [REDACTED: UNIVERSITY]. Total tuition cost for academic year 2025-2026 is ₱120,000.',
    description: 'Member Juan dela Cruz applying for educational scholarship for child. Child will be enrolled in Computer Science program at University of the Philippines. Total tuition cost for academic year 2025-2026 is ₱120,000.',
    ...
    suggestion: {
      ...
      confidence: 0.89,
      explanation: 'Standard educational scholarship application meets all criteria.',
      detailedReasoning: {
        factors: [
  ...
  },
  {
    ...
    redactedDescription: 'Member asking how to update personal information in the system. Standard FAQ question.',
    description: 'Member asking how to update personal information in the system. Standard FAQ question.',
  ...
  },
  {
    ...
    priority: 'Normal',
    status: 'auto-assigned',
    redactedDescription: 'Member requesting setup of automatic payroll deduction for union dues. Works at SM Makati branch.',
    description: 'Member requesting setup of automatic payroll deduction for union dues. Works at SM Makati branch.',
    ...
    suggestion: {
      ...
      confidence: 0.88,
      explanation: 'Payroll deduction request automatically routed to finance department.',
      detailedReasoning: {
        factors: [
  ...
  },
  {
    ...
    priority: 'High',
    status: 'needs-assignment',
    redactedDescription: 'Member reports ongoing workplace harassment by supervisor. Unsure if this should go to legal team or HR department. Complex situation involving multiple parties.',
    description: 'Member reports ongoing workplace harassment by supervisor. Unsure if this should go to legal team or HR department. Complex situation involving multiple parties.',
    ...
    suggestion: {
      ...
      confidence: 0.45,
      explanation: 'Complex case involving both legal and HR aspects. Manual assignment required.',
      detailedReasoning: {
        factors: [
        ...
        recommendation: 'Manual review required to determine appropriate department'
      },
      extractedEntities: [
  ...
  },
  {
    ...
    priority: 'Critical',
    status: 'in-progress',
    redactedDescription: 'Member lost job due to company downsizing. Requesting emergency financial assistance for basic needs. Case currently being evaluated by assistance team.',
    description: 'Member lost job due to company downsizing. Requesting emergency financial assistance for basic needs. Case currently being evaluated by assistance team.',
  ...
  },
  {
    ...
    priority: 'Normal',
    status: 'resolved',
    redactedDescription: 'Scholarship application approved. Payment processed. Case closed with member notification sent.',
    description: 'Scholarship application approved. Payment processed. Case closed with member notification sent.',
  ...
  },
  {
    ...
    priority: 'Low',
    status: 'auto-resolved',
    redactedDescription: 'Member forgot password and needs reset link. Automated system sent reset instructions via email.',
    description: 'Member forgot password and needs reset link. Automated system sent reset instructions via email.',
  ...
  },
  {
    ...
    priority: 'Normal',
    status: 'auto-assigned',
    redactedDescription: 'Member requesting dental assistance for root canal treatment. Estimated cost ₱15,000. Member has qualifying coverage.',
    description: 'Member requesting dental assistance for root canal treatment. Estimated cost ₱15,000. Member has qualifying coverage.',
  ...
  },
  {
    ...
    priority: 'Normal',
    status: 'needs-assignment',
    redactedDescription: 'Member asking about eligibility for multiple benefits including medical, educational, and housing assistance. Complex multi-department case.',
    description: 'Member asking about eligibility for multiple benefits including medical, educational, and housing assistance. Complex multi-department case.',
  ...
  },
  {
    ...
    priority: 'High',
    status: 'resolved',
    redactedDescription: 'Bereavement assistance processed for member. ₱25,000 death benefit paid. Documentation filed and case closed.',
    description: 'Bereavement assistance processed for member. ₱25,000 death benefit paid. Documentation filed and case closed.',
  ...
  },
  {
    ...
    priority: 'Low',
    status: 'auto-resolved',
    redactedDescription: 'Member asking about union benefits and eligibility requirements.',
    description: 'Member asking about union benefits and eligibility requirements.',
    ...
    suggestion: {
      ...
      suggestedAssignee: 'Auto-Response System',
      confidence: 0.97,
      explanation: 'Standard FAQ about union benefits automatically resolved.',
      detailedReasoning: {
        factors: [
    ...
    source: 'TUCP-ONE',
    hasSensitiveContent: false,
    aiResponse: 'Dear Grace, thank you for your inquiry about union benefits. As a TUCP ALU member, you have access to: 1) Medical assistance up to ₱100,000 annually, 2) Educational scholarships for children, 3) Emergency financial support, 4) Legal consultation services, 5) Death and disability benefits. To apply for any benefit, please log into your member portal or visit our office with required documents. For specific eligibility requirements, please refer to your member handbook or contact our benefits department directly.'
  },
  {
    id: '14',
    ...
    priority: 'Low',
    status: 'auto-resolved',
    redactedDescription: 'Member lost physical membership card and needs replacement.',
    description: 'Member lost physical membership card and needs replacement.',
  ...
  },
  {
    ...
    priority: 'Normal',
    status: 'auto-assigned',
    redactedDescription: 'Member applying for maternity benefit. Due date in December 2025. First pregnancy.',
    description: 'Member applying for maternity benefit. Due date in December 2025. First pregnancy.',
    ...
    source: 'TUCP-ONE',
    hasSensitiveContent: false,
    aiDraft: 'Dear Maria, your maternity benefit application has been received and assigned to our Medical Benefits Team. Based on your membership status and contribution history, you are eligible for our maternity assistance program. The benefit includes: 1) ₱25,000 delivery assistance, 2) ₱10,000 newborn care package, 3) Priority access to pediatric consultations. Please submit: birth certificate (after delivery), hospital bills, and medical records. Processing typically takes 5-7 business days after document submission.',
    suggestedResponse: 'Congratulations on your upcoming addition to the family! Your application appears complete and you meet all eligibility requirements. We recommend scheduling a consultation with our benefits counselor to discuss the full range of maternal and child benefits available to you.'
  },
  {
    id: '16',
    ...
    priority: 'Normal',
    status: 'auto-assigned',
    redactedDescription: 'Member needs vision care assistance for prescription glasses. Ophthalmologist recommended new prescription.',
    description: 'Member needs vision care assistance for prescription glasses. Ophthalmologist recommended new prescription.',
  ...
  },
  {
    ...
    priority: 'Normal',
    status: 'needs-assignment',
    redactedDescription: 'Member asking about coordinating multiple benefits: medical for surgery, educational for child, and housing loan application. Complex multi-department coordination needed.',
    description: 'Member asking about coordinating multiple benefits: medical for surgery, educational for child, and housing loan application. Complex multi-department coordination needed.',
    ...
    suggestion: {
      ...
      detailedReasoning: {
        ...
        recommendation: 'Assign to senior benefits coordinator for comprehensive review'
      },
      extractedEntities: [
    ...
    source: 'TUCP-ONE',
    hasSensitiveContent: false,
    aiDraft: 'Dear Angela, thank you for your comprehensive benefits inquiry. Your request involves multiple departments and requires coordination between medical, education, and housing teams. Given the complexity, we recommend scheduling a consultation with our senior benefits coordinator who can help you navigate all three applications simultaneously and ensure optimal timing and benefit maximization.',
    suggestedResponse: 'This multi-faceted request requires careful coordination. I recommend assigning to our Benefits Coordination Specialist who can work with all three departments to create an integrated benefits plan for this member.'
  },
  {
    id: '18',
    ...
    priority: 'High',
    status: 'needs-assignment',
    redactedDescription: 'Member terminated from employment, unclear if termination was legal. Needs both legal consultation and emergency financial support.',
    description: 'Member terminated from employment, unclear if termination was legal. Needs both legal consultation and emergency financial support.',
    ...
    suggestion: {
      ...
      suggestedAssignee: 'Needs Review',
      confidence: 0.42,
      explanation: 'Complex case requiring both legal and financial support assessment.',
      detailedReasoning: {
        factors: [
        ...
        recommendation: 'Manual assignment to determine primary department and escalation path'
      },
      extractedEntities: [
    ...
    source: 'TUCP-ONE',
    hasSensitiveContent: true,
    aiDraft: 'Dear Carlos, we understand you are facing employment termination and need support. This situation requires immediate attention from both our legal and emergency assistance teams. We will coordinate a response that addresses both your legal rights and immediate financial needs. Please expect contact from our legal department within 24 hours and emergency support team within 12 hours.',
    suggestedResponse: 'This case requires urgent dual-department coordination. Recommend immediate assignment to Legal Department for termination review with concurrent Emergency Support team activation for financial assistance assessment. Member should receive support within 24 hours.'
  },
  {
    id: '19',
    ...
    priority: 'High',
    status: 'in-progress',
    redactedDescription: 'Member recovering from major surgery, requesting extended medical assistance for rehabilitation and medication costs.',
    description: 'Member recovering from major surgery, requesting extended medical assistance for rehabilitation and medication costs.',
    ...
    progressDetails: {
      ...
      notes: 'Initial surgery costs approved (₱85,000). Now evaluating extended rehabilitation support request. Physical therapy and medication costs being reviewed by medical board.'
    }
  },
  {
    id: '20',
    ...
    priority: 'Normal',
    status: 'in-progress',
    redactedDescription: 'Member applied for university scholarship for child studying Engineering. Application under final review by education committee.',
    description: 'Member applied for university scholarship for child studying Engineering. Application under final review by education committee.',
    submittedDate: '2025-09-25T14:20:00Z',
    assignedTo: 'Education Team',
    suggestion: {
      category: 'University Scholarship',
    ...
    progressDetails: {
      ...
      notes: 'Student meets academic requirements (GPA 3.7). Family financial need verified. Scholarship amount being finalized based on tuition costs and available budget. Committee decision scheduled for October 4th.'
    }
  },
  {
    id: '21',
    ...
    priority: 'Normal',
    status: 'resolved',
    redactedDescription: 'Housing loan application for ₱500,000 approved. All documents processed and loan disbursed.',
    description: 'Housing loan application for ₱500,000 approved. All documents processed and loan disbursed.',
    ...
    resolutionDetails: {
      ...
      outcome: 'Successfully processed ₱500,000 housing loan with 5% interest rate, 10-year term. Monthly payments of ₱5,303.28 starting November 2025.',
      memberNotified: true,
      followUpRequired: false,
      notes: 'Member has been notified of loan approval and disbursement. Payment schedule provided. First payment due November 15, 2025.'
    }
  },
  {
    id: '22',
    ...
    priority: 'Critical',
    status: 'resolved',
    redactedDescription: 'Emergency medical assistance for heart surgery approved and payment processed. ₱150,000 emergency fund utilized.',
    description: 'Emergency medical assistance for heart surgery approved and payment processed. ₱150,000 emergency fund utilized.',
    ...
    resolutionDetails: {
      ...
      outcome: 'Successfully processed ₱150,000 emergency medical assistance for heart surgery. Payment made directly to hospital within 48 hours of request.',
      memberNotified: true,
      followUpRequired: true,
      notes: 'Emergency assistance provided for life-saving heart surgery. Member recovery progressing well. Follow-up visit scheduled for October 15th to check on recovery and any additional support needed.'
    }
  }
];

export const mockProponentTasks: ProponentTask[] = [
  {
    id: '1',
    ticketId: 'TCK-2025-0123',
    memberPseudonym: 'member-1973-ALU',
    suggestedResponse: 'Dear Member, your medical assistance request has been reviewed and approved. We will process a payment of ₱85,000 to cover your emergency surgery costs. Please submit your hospital bills within 30 days for reimbursement processing.',
  ...
  },
  {
    ...
    suggestedResponse: 'We have reviewed your legal consultation request regarding workplace harassment. Our legal team will contact you within 48 hours to schedule an initial consultation. Please prepare any relevant documentation for the meeting.',
